...
Default-профиль внешнего L4 использует `deepseek/deepseek-chat` через `http://127.0.0.1:8000/v1`. Его можно переопределить без изменения кода:

```powershell
$env:COGNITIVE_OS_L4_MODEL = "deepseek/deepseek-chat"
$env:COGNITIVE_OS_L4_BASE_URL = "http://127.0.0.1:8000/v1"
$env:COGNITIVE_OS_L4_RESPONSE_FORMAT = "0"
```
