...
from runtime.framework_plugin_certification import build_framework_plugin_certification
...
def main() -> int:
    ...
    parser.add_argument(
        "--evaluation",
        default="artifacts/field_trials/role_project_type_evaluation_20260830T161442270918Z.json",
    )
    ...
    if args.write:
        ...
        path = directory / f"framework_plugin_certification_{stamp}.json"
        path.write_text(
