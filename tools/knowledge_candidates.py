...
def main() -> int:
    ...
    report_parser.add_argument("--capability-gaps", action="store_true", help="aggregate foundation capability gaps")
    ...
    if args.command == "report":
        ...
        report = (
            capability_gap_report(candidates) if args.capability_gaps else
            grouped_candidate_report(candidates) if args.grouped else knowledge_candidate_report(candidates)
        )
