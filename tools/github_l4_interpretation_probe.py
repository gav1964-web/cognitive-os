...
def run_probe(
    *,
    ...
    cases = [_run_case(project_dir, config, context_mode) for project_dir in _project_dirs(projects_dir)]
    return {
...
def _run_case(project_dir: Path, config: LocalInferenceConfig, context_mode: str) -> dict[str, Any]:
