...
def main() -> int:
    ...
    parser.add_argument("--l4-base-url", default=os.environ.get("COGNITIVE_OS_L4_BASE_URL"))
    parser.add_argument("--l4-model", default=os.environ.get("COGNITIVE_OS_L4_MODEL"))
