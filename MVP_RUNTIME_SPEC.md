...
59.4.2. L4.5 Generated Corpus v0.1 представлен `runtime/l45_semantic_corpus.py` и CLI flags `tools/l45_semantic_benchmark.py --generated-corpus-size <N> --seed <seed>`. Curated 22 cases остаются portable smoke/acceptance set; generated corpus строится из seeded матрицы known templates, bounded unknown CLI/FastAPI prompts и clarification/unsupported boundaries. Generated 200-case corpus используется как local/nightly field trial, а не обязательный CI gate; первый deterministic прогон `--generated-corpus-size 200 --seed 45` проходит 200/200 с 104 L4.5 escalations.
