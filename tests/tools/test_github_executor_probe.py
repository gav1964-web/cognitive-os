...
def test_summary_counts_executor_acceptance_and_source_changes() -> None:
    cases = [
        {
            ...
            "isolated_dependency_profile_status": "ready_for_probe",
            "first_slice_reselection_status": "required",
            "first_slice_reselection_resolution_status": "exhausted",
    ...
    assert _summary(cases) == {
        ...
        "isolated_dependency_profile_statuses": {"none": 2, "ready_for_probe": 1},
        "first_slice_reselection_statuses": {"none": 2, "required": 1},
        "first_slice_reselection_resolution_statuses": {"exhausted": 1, "none": 2},
