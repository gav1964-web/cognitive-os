...
_CHECK_NAMES = [
    ...
    "defect_context_preserves_baseline_failure_evidence",
    ...
    "defect_context_preserves_causal_target_and_repair_mechanism",
    ...
    "defect_context_requires_baseline_replay_and_regression",
