...
from cognitive_replay.environment import freeze_environment_profile
from cognitive_replay.evidence import evidence_digest


@lru_cache(maxsize=1)
def _wheel_bytes() -> tuple[tuple[str, bytes], ...]:
...
@pytest.fixture
def profile_factory():
    return test_environment_profile
