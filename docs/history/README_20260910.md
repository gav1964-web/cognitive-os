...
The [2026-09-10 development checkpoint](../../DEVELOPMENT_STATUS.md) records the review
of pending historical-defect work, verification results, and the next evidence gates.
The [qualification v2 guide](../../HISTORICAL_DEFECT_QUALIFICATION.md) documents isolated
wheel environments, repeated baseline failures, exact pytest-node verification,
and the measured Rosbags case.
