...
The 2026-09-06 framework/plugin follow-up supersedes that readiness-only snapshot. Structural selection scanned 1,878 untouched local projects and found one project-owned plugin contract; the measured shortage authorized five revision-pinned external projects. Three acquisition owners exposed a project-recognition defect, which was corrected by preserving PEP 621 and Poetry plugin entry points as identity evidence. The frozen blind holdout then passed `3/3` across independent pytest, flake8 and local plugin owners, including one successful runtime target reselection. All six required role cells are mature at `9.7+`, the generated-function audit reports zero stubs, and the full regression preserves all 49 previously protected mature cells. Holdout receipt `sha256:c641cc575c989f30286fe3693ab59ba29e0be8cead6f3173fd2c520be6a551f8` and certificate receipt `sha256:2b753d022452ef95039e308a6048e3c89aea7eb256a71a4d883e90106f5d0ace` verify in the evidence ledger. Certification covers the demonstrated bounded framework/plugin contracts; stateful and effect-heavy framework behavior, automatic source apply and Web UI remain deferred.
