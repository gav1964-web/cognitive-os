...
Framework readiness remains `holdout_required` under receipt `sha256:d18873738e2cb6b8a3a299aa5d4dc63bacbcaca277676acb3a32a8bb5de51766`. A dedicated `FrameworkPluginCertification` gate now requires all six cells to be explicitly promotion-eligible plus a verified ledger receipt for a multi-lineage independent holdout, role-chain continuity, zero generated function stubs, bound inputs and no role regression. Current receipt `sha256:7f9b2efb4825a039efa3fba1438a5bdacfcc11d4916c6442ed2867893e86937c` is intentionally `evidence_required`; historical scores alone cannot grant certification.
