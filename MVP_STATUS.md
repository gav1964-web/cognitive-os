...
Narrow-role training replay update (2026-09-08): five consumed repairs across `cli_local_tool` (Click, Autoflake, isort) and `library_pure_transform` (Platformdirs, Marshmallow) now preserve a source-backed causal mechanism through Analyzer, Architect, SpecWriter, Implementer, Tester, and Reviewer. Every sandbox patch passed its exact failing node, full native regression, generated-stub gate, scope gate, and source-digest invariant. Structural checks are `10.0` for every role and case, while authority-aware training caps keep report `sha256:842b7b88716714054a8a6c0e932a9c6302c5c72ca05ba7e60c00bae25fcb02cb` at `9.4/8.5/8.5/9.0/8.8/8.8`. This supersedes older known-case replay totals but does not supersede the unseen baseline or restore certification. The next gate is a frozen owner-independent holdout with previously unseen failure mechanisms.
